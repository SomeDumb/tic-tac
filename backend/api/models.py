...
class Room(models.Model):
    ...
    x_user = models.ForeignKey(User, related_name='%(class)s_x', on_delete=models.SET_NULL, blank=True, null=True)
    
    o_user = models.ForeignKey(User, related_name='%(class)s_o', on_delete=models.SET_NULL, blank=True, null=True)
